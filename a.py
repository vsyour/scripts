...
if not os.path.isfile(path):
    ...
    moves.urllib.request.urlretrieve("https://raw.githubusercontent.com/vsyour/scripts/master/fileNames", path, context=context)
...
def writeFile(content):
    with open("passwd.txt","a") as f:f.write(content+"\n")
